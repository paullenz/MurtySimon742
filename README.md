...
**23 September audited frontier:** Internal [zero-demand rigidity](project/research/general_n/2026-09-22-zero-demand-equality-v1/ZERO_DEMAND_EQUALITY.md), residual-support analysis, and exact residual quotient/source/supplement screens support the edge bound for total demand S<=13 and balanced complete-bipartite equality through S<=8. The daily audit found two committed evidence files corrupted by truncated tool output; their originals are preserved, clean source regeneration now passes the r=8 and r=11 cross-file replays, and hostile residual-free-helper checks did not reopen r=10 or r=11. These remain internal candidate/computer-assisted results, not external verification. The r=12 support-ten supplement screen, positive-demand strip and broader equality characterization remain open.
