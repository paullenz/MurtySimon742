...
| Active continuation | Complete the exact 306-state remote coverage; preserve later witnesses and independently audit closures; pursue a compression theorem reducing arbitrary deficient flow cuts to monotone `rho`/`q` threshold cuts; promote nothing until complete key coverage and the reviewed promotion gate succeed |
