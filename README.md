...
| Row471 conditioned progress | Earlier branches `e_L=39,40` are exactly hand/verifier closed; new [`row471-e41-v1`](project/research/general_n/2026-09-15-row471-e41-v1/README.md) closes `e_L=41` by a shared high-excess/common-pressure incidence contradiction `28>24`. Row471 remains open on `42,43,47` |
...
| Active continuation | Attack row471 `e_L=42` next with the same shared high-excess/common-pressure mechanism first; if it does not close, add selected-label/destination plus ONE common residual-neighbourhood constraint. Then test `43,47` |

**Checkpoint — 15 September 2026, `row471-e41-highblock-v1`.** Inspected predecessor `2667a909f8eec2f7ade27712cc65f6d345b663d2`. The conditioned row471 branch `eta=2,e_L=41` is now exactly closed in the existing selected-incidence/common-pressure relaxation. High-block excess is six; receiver pressure forces at least ten pressure units onto the nine high-eligible sources; exact integer exhaustion leaves only 25 pressure/three-low-slot pairs and proves that positive-pressure sources must make at least 28 high selections, while positive-excess high labels can carry at most 24 incidences. **Row471 remains open on 42,43,47; original sample remains 708/713; canonical finite frontier remains 4,626 / 952 / 3,632.** Predecessor `2667a909...` published the research note before the paired live-status update; that synchronization failure is preserved and corrected here rather than glossed over. External mathematical review remains OPEN.
...
- [Row471 `e_L=41` high-block closure](project/research/general_n/2026-09-15-row471-e41-v1/README.md): receiver pressure plus one common high-excess budget forces at least28 high selections from positive-pressure sources, but positive-excess high labels can carry at most24; remaining conditioned branches are42,43,47.
