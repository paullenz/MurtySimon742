...
| Latest necessary bound | [Source-priced selected-incidence charge](project/research/general_n/2026-09-14-source-sharing-v1/README.md): signed source prices restore the exact row budgets; hand derivation and finite internal checks, external review open |
| Retained deterministic source-price experiment | 576 exact price evaluations on six original profiles; four weighted bounds improve against their own zero-price baseline, but zero new profile exclusions; fresh seven not retested |
| Stronger search and boundary evidence | [Separate price/witness continuation](project/research/general_n/2026-09-14-source-pricing-witnesses-v1/README.md): 21 of 24 tested bounds improve; three integer-checked joint-incidence/orientation witnesses show the stated uncoupled relaxation is feasible for original160,338,347. No graph realization or new profile exclusion |
...
| Fresh-seed sample | 708 of 715 rejected; seven not rejected, in a separate row namespace; same generator, not independent generation; neither price experiment retested these seven |
...
| Verification scopes | Shared-slack run34898768799 and status-synchronization run34902757136 have recorded passes. The separate price/witness package passed LOCAL exact replay; the original price workflow does not verify it. No new live remote result is asserted here |
| Active continuation | Enforce selected-label/destination and one common residual-neighbourhood coupling over all allowed realizations. The three particular witnesses violate these stronger conditions, but their profiles are NOT excluded. Retain conditioned pricing as a parallel route |

**Checkpoint — 14 September 2026, `source-pricing-witnesses-v1`.** Inspected publication predecessor: `788819f813e92d32470ff23783a9dc9faf7a4ce1`. The fixed-order/general summaries remain near the top. This commit preserves the concurrent source-price implementation, workflow, quantifier correction, link repairs, reviewer invitation and failure policy, while publishing the stronger price search and exact witness analysis in a distinct sibling package. Local checks cover9,043 incidence configurations,626 independent column enumerations,1,000 valid oriented-incidence lower checks,24 fixed-price replays and18 rejected witness corruptions. Row108's weighted upper bound improves705 to517 against lower457, still not a contradiction. The three witnesses prove feasibility only in the explicitly listed uncoupled relaxation; all fail stronger label/destination tests. **Fixed-order, general7/12 and canonical-frontier status unchanged; no new profile closure.** See the [publication reconciliation](project/research/general_n/2026-09-14-source-pricing-witnesses-v1/PUBLICATION.md) and retained [documentation check history](project/reviews/cross-cutting/2026-09-14-status-sync-v1/README.md).
