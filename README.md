...
| `n=30` | Complete candidate: `e(G) <= 225`, equality exactly `K(15,15)`; frozen Fan-free reviewer v2 plus candidate hand hardening of the Delta=16 upper-bound branch; **four explicit joint-envelope certificates now exclude all 211 tight Delta=16 equality rows**; finite demand classification/envelope arithmetic and independent review remain open |
...
The earlier [57-row scalar reduction](project/research/n30/2026-09-11-m225-hall-continuation-v1/README.md) and its 150-row remainder are preserved as history. Conditional on the complete 100-profile input and the bridge, the final endpoint LP/Farkas models are no longer needed in the new supplementary route. **The 100-profile completeness classification and explicit finite envelope arithmetic remain dependencies**; no fully hand-derived N30 proof or new reviewer edition is claimed. The next Delta=16 target is the hand classification of those 100 demand profiles.
