...
| New source-sharing experiment | 576 exact price evaluations on six original profiles; four weighted bounds improve against their own zero-price baseline, but **zero new profile exclusions**; fresh seven not retested |
...
| Last recorded completed checks | Shared-slack run 34898768799 passed its scope; status-synchronization run 34902757136 passed. New source-price remote replay is not yet claimed passed at this checkpoint |
| Active continuation | Combine source pricing with the SAME conditioned excess totals and branch-specific caps, retain complete branch coverage, and compare sharper receiver lower bounds |

**Checkpoint — 14 September 2026, `source-price-envelope-v1`.** Inspected predecessor: `e7a06e6554c9570566a84ea41f4cfb913572c1e0`; its reviewer-first introduction and the failure-retention section from5140548a are preserved. This commit publishes the source-price proof, exact verifier, inputs, full results including failures, and offline replay. Local checks passed 9,043 incidence/demand configurations, 371 brute-force DP comparisons and three hostile/boundary fixtures. **Fixed-order and canonical-frontier mathematical status unchanged; no new profile closure.** The q-layer research-target quantifier is explicitly corrected without changing its preceding identities or recorded certificates. Two README link-check failures are diagnosed and their targets corrected; fresh remote link/research checks remain a separate gate. See [check history](project/reviews/cross-cutting/2026-09-14-status-sync-v1/README.md).
...
The [shared-slack proof package](project/research/general_n/2026-09-14-joint-blocks-v1/README.md), [offline replay guide](project/research/general_n/2026-09-14-joint-blocks-v1/REPRODUCE.md), [research evidence index](RESEARCH_EVIDENCE_INDEX.md), and [durable-evidence publication audit](project/research/general_n/2026-09-14-evidence-preservation-v1/PUBLICATION_AUDIT.md) retain exact inputs, proofs, failures, counterexamples and replay scopes. A successful file write or queued workflow is not verification. The new [source-price package](project/research/general_n/2026-09-14-source-sharing-v1/README.md) adds its separate exact, non-closing experiment.
