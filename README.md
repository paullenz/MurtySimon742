...
| Canonical forced-core discovery | Research branch [`canonical-forced-core-scan-v1`](project/research/general_n/2026-09-15-forced-core-canonical-scan-v1/README.md) pins the promoted relational source and resumes complete `q` enumeration when needed. Of the 952 stored relational witnesses, **646 already survive** the new theorem and **306 require resumed enumeration**. This witness split is only a scan plan, not 306 whole-state exclusions; canonical frontier unchanged |
...
| Active continuation | Run the exact sharded resumed enumeration on the 306 witness-killed canonical states; preserve every later `q` witness and treat any full-state closure as discovery-only until separate audit/promotion |

**Checkpoint — 15 September 2026, `canonical-forced-core-scan-v1` installation.** Inspected predecessor `b405cf8b2cd0c18bb488391e96491d977092f19d`. The arbitrary-`r` forced eligibility-core/high-demand test has been embedded into the exact post-pair relational enumerator. A pinned pre-screen shows that 646/952 canonical survivors retain their existing relational witness and therefore cannot be excluded by this route; 306/952 have their stored witness rejected and require resumed enumeration over all admissible `q` profiles. Local regression reproduces the old state97 witness after 8,678,218 profiles, while state `N34:152` is exhausted and closed after 27,787,962 profiles. **Mathematical/canonical status is unchanged: 4,626 exclusions / 952 survivors / 3,632 whole-state closures. No new canonical exclusion is promoted by this installation commit.** External mathematical review remains OPEN.
...
- [Canonical forced-core discovery scan](project/research/general_n/2026-09-15-forced-core-canonical-scan-v1/README.md): exact arbitrary-`r` theorem inserted into the promoted relational `q` enumeration; 646 stored witnesses survive immediately and 306 witness-killed states are queued for resumed exhaustive enumeration. No canonical promotion is implied by this research-branch installation.
