...
| Forced-core receiver-price census | [`forced-core-receiver-price-gap-census-v1`](project/research/general_n/2026-09-15-forced-core-receiver-price-gap-census-v1/README.md) launches a complete 170-candidate aggregate-versus-exact-partition census, with exact profile/core-failure reconciliation and preserved partition-only witnesses. Analytic census only; no promotion implied |
...
| Active continuation | Complete the 170-candidate independent audit and survivor replay gate; in parallel run the full receiver-price gap census, preserving any partition-only obstruction; then seek a Hall/flow-duality or integrality theorem only if the finite census supports it. Promote nothing before complete independent agreement |
...
- [Receiver-price gap census](project/research/general_n/2026-09-15-forced-core-receiver-price-gap-census-v1/README.md): complete 170-candidate finite census comparing scalar/fractional aggregate obstructions against the exact labelled-partition DP, with exact authoritative core-failure reconciliation and explicit preservation of any gap witness.
