...
| `n=30` | Complete candidate: `e(G) <= 225`, equality exactly `K(15,15)`; frozen Fan-free reviewer v2 plus a **complete supplementary proof with hand lemmas and explicit integer tables**; independent internal Delta=16 assembly audit PASS; Delta>=17 closed by a hand tail bound and Delta=15 equality proved directly; finite-table and independent specialist review remain open |
...
**The explicit Delta=16 classification, residual-tail and endpoint arithmetic remain proof-critical finite tables.** The assembled route has no remaining separate Delta=17 computational branch, but it is not a table-free proof. The frozen reviewer-v2 package and earlier [scalar checkpoint](project/research/n30/2026-09-11-m225-hall-continuation-v1/README.md) remain preserved. The next task is a coherent new reviewer edition; no new PDF or external acceptance is claimed by this checkpoint.
...
| n=30 | [Reviewer manuscript v2](releases/n30-reviewer-v2/N30_Reviewer_Manuscript_v2.pdf); [latest supplementary assembly](project/research/n30/2026-09-11-assembled-hand-route-v1/ASSEMBLED_PROOF.md) | [Verification companion v2](releases/n30-reviewer-v2/N30_Verification_Companion_v2.pdf) |
