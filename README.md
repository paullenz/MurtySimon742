...
| Latest conditioned test | [Conditioned source pricing](project/research/general_n/2026-09-14-conditioned-source-pricing-v1/README.md): same block-excess branches and legitimate caps; 9,293 local incidence configurations, 24,063 priced inequalities and 150 strict improvements over zero prices. Six original and seven fresh boundary profiles tested separately; **no new exclusion** |
| Closest conditioned branches | Original row471, eta=2: e_L=39 gives upper225 versus lower224; e_L=40 gives upper225 versus lower223. Neither is a contradiction |
...
| Original synthetic sample | 707/713 rejected; six not rejected: 108,160,338,347,471,586 |
| Fresh-seed sample | 708/715 rejected; seven retained in a separate namespace. Same generator, not independent generation. The conditioned continuation retested all seven without new exclusions |
...
| Verification scopes | On788819f8, status, reviewer navigation, N30 package and q-layer checks passed. Original source-price34904353492 failed on a data-transfer hash before mathematics; its restoration status appears below. Stronger/witness and conditioned packages retain their separately stated local/remote scopes |
| Active continuation | Row471 e_L=39/40 and common selected-label/destination/residual-neighbourhood coupling; seek a structural contradiction across ALL allowed realizations, not just rejection of the three particular witnesses |

**Research checkpoint retained — `7504cfa5f9899b9e2b088fc07142e4445ca049bc`, 14 September 2026.** The conditioned scan applies inherited rejections first and source-prices the remaining branches at its targeted eta. Row471's best integer price places 1 on source indices9 and23; fresh391 improves by4,3,2,1 across its four branches and fresh528 by1 on one branch, without exclusion. Full frozen conditioned output SHA256: `1aec5dc47102ec24f64cc9776c624b32d025112b06fb643f306a0768e091639a`. The preceding [stronger search/witness checkpoint](project/research/general_n/2026-09-14-source-pricing-witnesses-v1/README.md) and all original negative results remain preserved. **Fixed-order, general7/12 and canonical-frontier status unchanged.** No new live conclusion for the conditioned workflow is asserted by this maintenance checkpoint.

<!-- SOURCE-PRICE-PUBLICATION:START -->
**Maintenance checkpoint — 14 September 2026, `source-price-publication-repair-v1`.** Inspected predecessor: `7504cfa5f9899b9e2b088fc07142e4445ca049bc`. The original result-file mismatch is an extra zero in row338's weighted price vector, NOT merely JSON formatting. Exact local diagnosis reproduces the full bad hash, and deterministic removal restores the original full-byte hash. This commit restores the original replay harness and installs a narrowly scoped, hash-gated data restoration. The dedicated workflow must pass the unchanged full replay before atomically publishing corrected raw JSON and BOTH status receipts. **Remote restoration is not yet claimed completed at publication. Mathematical status unchanged.** The newer conditioned and witness research is preserved. See [repair audit](project/research/general_n/2026-09-14-source-sharing-v1/CI_AUDIT.md). The next mathematical step remains row471 and label/destination/common-residual-neighbourhood coupling.
