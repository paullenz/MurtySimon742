...
**24 September audited frontier:** Internal [zero-demand rigidity](project/research/general_n/2026-09-22-zero-demand-equality-v1/ZERO_DEMAND_EQUALITY.md), residual-support analysis, and exact residual quotient/source/supplement screens retain the edge bound for total demand `S<=13`; balanced complete-bipartite equality remains supported only through `S<=8`. The r=12 support-ten source count was corrected from 42 to 32 and all 6,386 source kernels replayed cleanly, but the load-bearing helper screen did not reproduce: all 32 fresh rows timed out under the committed 180-second limit. The saved earlier run claims 32 infeasibilities; `S<=14` is frozen pending decisive independent reproduction or certificates. The positive-demand strip and broader equality characterization remain open.
