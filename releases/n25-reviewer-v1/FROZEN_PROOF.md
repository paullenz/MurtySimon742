# N=25 Murty–Simon: assembled candidate proof and full-chain audit

6 September 2026. New work assembled by ChatGPT/Codex for Paul Lenz.

**Status:** internal mathematical audit and exact computational corroboration. This document is a candidate proof, not external expert sign-off or formal verification. The older project certification ledger is not silently promoted. New arguments below replace dependencies on the parked Delta=15 hand proof; they do not retrospectively certify that historical proof.
...
Fan reduces any upper-bound counterexample to 157 edges. The degree-sum bound covers Δ≤12; Section 3 covers Δ=13; the original reviewed finite argument covers Δ=14; Sections 4–7 cover Δ=15,16; and the published maximum-degree input covers Δ≥17. The bipartite and star cases were settled before taking complements. Thus these candidate deductions imply e(G)≤156 for every 25-vertex diameter-2-critical graph.
