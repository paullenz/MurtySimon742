...
The current fixed-order PDF packages are Fan-free reviewer-v2 at `n=25,27,28`, **reviewer-v4 at `n=29`**, and **reviewer-v3 at `n=30`**. Source-first reviewer-v1 packages cover `n=31,32,33`. The 12 September step-back programme also has a source-first general-theory package collecting the new balanced-degree, `a=14`, fifteen-label and sixteen-label structural results.
...
| n=34 partial | `e(G)<=290`; target 289 and equality classification remain OPEN | [partial route](../project/research/n34/2026-09-12-frontier-v1/README.md) | [solver-free verifier](../project/research/n34/2026-09-12-frontier-v1/verify_upper_layers.py) | 291/292-edge layers closed; 289/290 layers OPEN; not a complete fixed-order candidate |
...
This index covers the project's current **theorem-level candidate claims**: fixed-order candidates at `n=25,27,28,29,30,31,32,33`; retained general maximum-degree candidates `13/22`, `293/500`, `7/12`; and the new step-back structural candidates above. The 7/12 profile-integral strengthening remains the strongest current broad maximum-degree threshold. The balanced-degree theorem is a different all-order reduction at the minimum possible dense maximum degree. The `a=14`, fifteen-label and sixteen-label results operate in fixed complement-minimum-degree bands.
...
The joint-clipping continuation adds fixed-a scalar results through a=23 and
the partial n=34 upper bound of 290. It does not extend the complete fixed-order
frontier beyond n=33. The [latest source package](general-joint-clipping-reviewer-v1/README.md)
records all new dependencies, corrections and exact replay entry points.
