...
\usepackage{fancyhdr}
\pagestyle{fancy}\fancyhf{}\fancyhead[L]{Murty--Simon at order 28}\fancyhead[R]{Reviewer edition 2}\fancyfoot[C]{\thepage}
...
\date{9 September 2026\\\small Fan-free reviewer edition 2; independent mathematical review open}
...
Historically, reviewer edition 1 used Fan's strict estimate, as reported by Wang \cite[p.~2]{wang}, to deduce $m\le197$. Fan remains cited for attribution, but his theorem is \emph{not} a logical dependency of edition 2. The replacement is the project note \texttt{project/research/fan-free-fixed-orders/2026-09-09-v1/FAN\_FREE\_REDUCTION.md}: the existing 197-edge calculation remains unchanged, while every $m\ge198$ is excluded directly. Degree sum handles $\Delta\le14$; fresh exact arithmetic closes $\Delta=15$ for $m=198,\ldots,210$; the pointwise charging bound at $\Delta=16$ and residual h-index bounds at $\Delta=17,\ldots,26$ only strengthen as $m$ increases; and $\Delta=27$ is the star case. The historical Fan-based reviewer-v1 manuscript remains preserved unchanged.
