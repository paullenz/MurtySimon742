---
title: "Murty-Simon at n=27: Fan-free candidate proof"
...
**Canonical claim.** `e(G) <= 182, equality exactly K(13,14)`.

**Logical source.** `project/reviews/n27/2026-09-09-fan-free-v2/PROOF.md`.

**History rule.** Reviewer v1 is not overwritten; edition 2 is a new proof surface.

---

# Murty–Simon at n=27: Fan-free candidate proof, edition 2
...
**Historical source preserved:** `project/reviews/n27/2026-09-07-candidate-v1/PROOF.md` (SHA-256 `97586723a7f85a0d6351e84ebfbeccdf2cb0a2817cb7977599190194779881b1`).
...
Proof: every selected edge with such a label satisfies the pair bound in (7.1). By the Section 4 selection convention, each selected edge is the unique designated representative of its missing unordered B-pair. Therefore two selected edges cannot be opposite orientations of the same pair, and their unordered source/supplement pairs are distinct. This gives the stated injection. The fixed R supplies the left side; no graph-realizability assumption is made about other retained columns.
