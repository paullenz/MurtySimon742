...
The later [N30 threshold-tail research supplement](project/research/n30/2026-09-11-threshold-tail-v1/README.md) supplies a candidate hand route for `Delta=16,m>=226`, including the exact seven-profile/nine-row endpoint classification. At 225 edges, the [four joint-envelope certificates](project/research/n30/2026-09-11-m225-resource-envelope-v1/README.md) now exclude **all 211 tight rows**, including the four zero-demand rows; the other 61 historical rows die by ledger equality. Their validity has a written monotone-incidence/resource derivation and a separate solver-free checker. This replaces the final endpoint LP/Farkas models in the supplementary route, conditional on the complete 100-profile demand input and bridge. That input and the explicit finite envelope arithmetic still require review; no fully hand-derived N30 proof or replacement reviewer edition is claimed. The prior 57-row scalar checkpoint is preserved as history.
