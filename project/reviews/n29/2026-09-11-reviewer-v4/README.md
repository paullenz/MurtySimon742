...
This removes all proof-critical N29 Delta=16 computation from the candidate theorem. The corrected minimal-kernel/Farkas route remains preserved as independently reproducible corroboration.
