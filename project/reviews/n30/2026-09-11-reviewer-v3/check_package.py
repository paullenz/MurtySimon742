...
def main():
    ...
    assert all(p in SURFACES or p.startswith('project/reviews/n30/2026-09-11-reviewer-v3/') or p.startswith('releases/n30-reviewer-v3/') or p=='.github/workflows/n30-reviewer-v3-package.yml' for p in changed),changed
    ...
    result={'status':'PASS','source_hashes_checked':len(source_map['input_sha256']),
        ...
        'release_manifest_files_checked':manifest_count,'external_review':'OPEN'}
