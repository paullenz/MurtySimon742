...
`OPPOSITE_EDGE_PLANE_IMPOSSIBLE.md` subsequently proves that the support is impossible. The conditional factorization above remains correct at its stated antecedent but is now vacuous for actual graphs.
