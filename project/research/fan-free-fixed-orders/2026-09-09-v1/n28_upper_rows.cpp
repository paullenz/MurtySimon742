// Fan-free n=28, Delta=15 residual-row scanner for m=198,199.
// Parameterization of the audited minimal source-capacity Hall scanner at A=12,B=15.
#include <array>
#include <vector>
#include <fstream>
#include <iostream>
...
#include <cstdint>
using namespace std;
static constexpr int A=12,B=15,MAXR=66;
...
int main(int argc,char**argv){
 if(argc!=4){cerr<<"n28_upper_rows demands.txt survivors.txt bands.txt\n";return 2;}
