# N34 state 77 — whole-state exclusion
...
Frozen state: `n2=7, n3=8, rho=1^7,2^4,3^7, S=38, r=36, a=15, b=18`.

The earlier full `E=0..34` low-demand scan had nonpositive layers only at `E={0,1,3,4,5,6,7}`. The joint-Hall class-packing replay at commit `9a7a67a930c5cda80b12b7695b31d897aa9ba2d9` made `E={1,3,4,5,6,7}` strict, leaving only `E=0`.
...
`state=77 profiles=201670 passing=0 Q=38 max_min_cut=32 minimum_deficit=6`

Thus every one of the 201,670 E=0 q-profiles violates a necessary orientation-capacity cut; even the closest profile is six incoming incidences short.
...
Therefore state 77 is excluded as a whole scalar state in the frozen N34 experiment. This inherits the trust boundary of the canonical selected/residual bridge and the frozen N34 catalogue.