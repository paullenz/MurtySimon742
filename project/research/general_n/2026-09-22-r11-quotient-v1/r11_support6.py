#!/usr/bin/env python3
"""Exact r=11 quotient/source screen for residual support exactly six."""
...
for R in parts(11):
 if len(R)!=6:continue
 pairs=list(itertools.combinations(range(6),2));idx={e:q for q,e in enumerate(pairs)};perms=list(perms_for(R));reps={}
