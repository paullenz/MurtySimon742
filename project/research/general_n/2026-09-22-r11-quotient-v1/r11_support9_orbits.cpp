...
static int rcode(const array<int,9>&R){int x=0,m=1;for(int r:R){x+=m*r;m*=5;}return x;}
int main(){
 ...
 const array<array<int,9>,2>parts={{{3,1,1,1,1,1,1,1,1},{2,2,1,1,1,1,1,1,1}}};
 for(int ci=0;ci<2;ci++){long long coloured=0,surv=0;bool a[9][9];
