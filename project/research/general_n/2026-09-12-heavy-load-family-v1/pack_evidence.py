...
def main():
    files={}
    for name in ('frontier_results.jsonl','profile_results.jsonl','remaining_states.json'):
    ...
    report=dict(schema='heavy-load-family-evidence-storage-v1',encoding='base64(gzip(original)); mtime=0',files=files)
