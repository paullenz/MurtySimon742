...
The [targeted literature note](LITERATURE_NOTE.md) records the 2014 published thresholds 0.7 (all n) and 0.6789 (n>=2000), and the 2016/2018 arXiv v2 all-order threshold approximately 0.6755. The present 0.6116 candidate is numerically much lower, but the search is not exhaustive and no best-known, novelty or priority claim is made pending specialist review.

The exact check verifies algebra only. The graph-to-selected-system and demand-tail lemmas remain hand proofs. No finite-order certificate enumeration, Fan bound, weak-core reduction or positive-surplus residual-activity lemma is used.
