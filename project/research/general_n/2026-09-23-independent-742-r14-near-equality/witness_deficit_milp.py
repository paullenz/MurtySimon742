...
def solve_aggregated(demands, xs, rho, Delta, time_limit=20):
    ...
    for i in range(k):
        # Graph-level star slack.  The n=18, Delta=10 finite
        # certificate-cover calculation strengthens x=7 to slack 30 and
        # proves x=8 cannot have slack <=34 (hence slack >=35).
