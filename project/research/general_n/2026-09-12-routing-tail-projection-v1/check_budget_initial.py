...
def main():
    ...
    invalid=[
        ...
        dict(claim='Drop the j=0 case in the equality bound',h=2,z=2,H=[2,2],p=[0,0],heavy_sum=4,wrong_upper=0,
             explanation='This local extremal configuration has no high senders; the hz branch is required. It is not asserted to be a D2C graph.'),
