...
static int rcode(const array<int,8>&R){int x=0,m=1;for(int r:R){x+=m*r;m*=6;}return x;}
int main(){
 ...
 const array<array<int,8>,5>parts={{{5,1,1,1,1,1,1,1},{4,2,1,1,1,1,1,1},{3,3,1,1,1,1,1,1},{3,2,2,1,1,1,1,1},{2,2,2,2,1,1,1,1}}};
 for(int ci=0;ci<5;ci++){long long coloured=0,surv=0;bool a[8][8];
